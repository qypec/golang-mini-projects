...
var ffjKeyUserBrowsers = []byte("Browsers")
	...
	for {
		...
		case fflib.FFParse_want_key:
			...
			if len(kn) <= 0 {
				...
				case 'B':
					...
					if bytes.Equal(ffjKeyUserBrowsers, kn) {
						currentKey = ffjtUserBrowsers
						state = fflib.FFParse_want_colon
						goto mainparse
					}
				...
				if fflib.EqualFoldRight(ffjKeyUserBrowsers, kn) {
					currentKey = ffjtUserBrowsers
					state = fflib.FFParse_want_colon
					goto mainparse
				}
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtUserBrowsers:
					goto handle_Browsers
...
handle_Browsers:
	...
	/* handler: j.Browsers type=[]string kind=slice quoted=false*/

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				/* handler: tmpJBrowsers type=string kind=string quoted=false*/

				{
					...
					if tok == fflib.FFTok_null {
						...
						tmpJBrowsers = string(string(outBuf))

					}
				}

				j.Browsers = append(j.Browsers, tmpJBrowsers)
